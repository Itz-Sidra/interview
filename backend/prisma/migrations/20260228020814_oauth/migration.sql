...
-- CreateEnum
CREATE TYPE "InterviewPurpose" AS ENUM ('JOB', 'EXAM');

-- CreateEnum
CREATE TYPE "AnalysisIntensity" AS ENUM ('STANDARD', 'DETAILED', 'COMPREHENSIVE');
...
CREATE TABLE "InterviewConfig" (
    ...
    "purpose" "InterviewPurpose" NOT NULL DEFAULT 'JOB',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "companyType" TEXT,
    "examSubject" TEXT,
    "examType" TEXT,
    ...
    "analysisFacial" BOOLEAN NOT NULL DEFAULT true,
    "analysisTechnical" BOOLEAN NOT NULL DEFAULT true,
    "analysisVocal" BOOLEAN NOT NULL DEFAULT true,
    "analysisLinguistic" BOOLEAN NOT NULL DEFAULT true,
    "analysisIntensity" "AnalysisIntensity" NOT NULL DEFAULT 'DETAILED',
    "resumeId" TEXT,
...
-- AddForeignKey
ALTER TABLE "InterviewConfig" ADD CONSTRAINT "InterviewConfig_resumeId_fkey" FOREIGN KEY ("resumeId") REFERENCES "Resume"("id") ON DELETE SET NULL ON UPDATE CASCADE;
